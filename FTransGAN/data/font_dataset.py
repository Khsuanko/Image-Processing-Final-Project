...
class FontDataset(BaseDataset):
    ...
    def get_style_paths(self, parts):
        english_font_path = os.path.join(parts[0], parts[1], parts[2], self.style_language, parts[4])  # [MODIFIED]
    ...
    def get_content_path(self, parts):
        return os.path.join(parts[0], parts[1], parts[2], 'source', parts[5])  # [MODIFIED]
